...
import Oportunidades from 'components/administrardatos/Oportunidades';
import { Oportunidad, OportunidadH } from 'components/administrardatos/Oportunidad';
    ...
    return (
        <Suspense fallback={<LoadingComponent loading />}>
            <Switch>
                ...
                <Route exact path={SLUGS.overviewTwo} render={() => <div><OportunidadH/><Oportunidad/></div>} />
                <Route exact path={SLUGS.overviewThree} render={() => <div>overviewThree</div>} />
                <Route exact path={SLUGS.overview} render={() => <Oportunidades/>} />
